...
import {
  ...
  type DocumentAnnotationFormHandle,
...
export function DocumentAnnotationsSection({
  ...
  const formRef = useRef<DocumentAnnotationFormHandle>(null);
          ...
          {canAnnotate &&
            (isEditing ? (
              <Flex direction="row" gap="size-100">
                <Button size="S" onPress={handleCancel}>
                  Cancel
                </Button>
                <Button variant="primary" size="S" onPress={handleSaveClick}>
                  Save
                </Button>
              </Flex>
            ) : (
